...
/** Write A Program to find out length of name */

    val name: String? = "heet"      // change it "heet" to "null" and see the effect in output
...
/** 3. Elvis-operator ( ?: )
    When we have nullable reference 'name', we can say "is nmae is not null", use it,
